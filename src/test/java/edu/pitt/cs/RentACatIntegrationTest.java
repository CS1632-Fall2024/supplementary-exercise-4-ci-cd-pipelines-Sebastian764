...
public class RentACatIntegrationTest {
	...
	public void testGetCatNullNumCats0() {
		...
		try {
			// call getCat(2)
			var method = r.getClass().getDeclaredMethod("getCat", int.class);
			method.setAccessible(true);
			result = method.invoke(r, 2);
		} catch (NoSuchMethodException | IllegalAccessException | InvocationTargetException e) {
			fail("Exception occurred while pointlessly doing stupid shit instead of changing a method from private to public: " + e.getMessage());
		}
		assertNull(result);
	...
	public void testRenameFailureNumCats0() {
		...
		// Check that renameCat returns false
		assertFalse(result);
		String expectedOutput = "Invalid cat ID." + newline;
		assertEquals(expectedOutput, out.toString());
	}
	...
	public void testRenameNumCat3() {
		...
		// Stub the behavior of c2.getName()
